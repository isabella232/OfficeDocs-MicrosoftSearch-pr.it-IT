...
Il connettore Grafico dei siti Web aziendali consente all'organizzazione di indicizzare articoli e contenuti dai siti Web **interni.** Dopo aver configurato il connettore e sincronizzato il contenuto dal sito Web, gli utenti finali possono cercare tale contenuto da qualsiasi client Microsoft Search.
...
Esistono due modi per impedire la ricerca per indicizzazione delle pagine: disattivarle nel file robots.txt o aggiungerle all'elenco di esclusione.
