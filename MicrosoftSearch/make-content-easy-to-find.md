...
Microsoft Search aiuta gli utenti a trovare contenuto pertinente. È un modo sicuro per eseguire ricerche sia nel contenuto Intranet che nel contenuto Web. Questo tipo di integrazione nel Web e nelle organizzazioni è disponibile solo da Microsoft. Con Microsoft Search, gli amministratori possono utilizzare le proprie conoscenze di un'organizzazione per semplificare agli utenti la ricerca di contenuto pertinente. 

## <a name="components-that-find-content"></a>Componenti che trovano contenuto
In Microsoft Search, gli amministratori creano [segnalibri,](manage-bookmarks.md) [PowerApps,](integrate-powerapps.md) [domande&A](manage-qas.md)e Posizioni che semplificano la ricerca del contenuto. [](manage-locations.md) Ognuno dei componenti della ricerca include un titolo, un URL e un set di parole chiave di attivazione.
...
- Per scaricare l'estensione Edge, vai a [Microsoft Store.](https://www.microsoft.com/p/microsoft-search-content-creator/9nrqdbcbwq55?activetab=pivot:overviewtab)
...
1. Nell'interfaccia di amministrazione [](https://admin.microsoft.com)di Microsoft 365 passare a **Impostazioni**  >  **Microsoft Search.** 
...
Sfruttare gli esperti in materia (PMI) nell'organizzazione, inclusi esperti di risorse umane, supporto, vendite, tecnologia e altre aree chiave. Le PMI possono contribuire direttamente al contenuto se vengono aggiunti come editor di Microsoft Search. 
...
1. Nell'interfaccia di amministrazione [](https://admin.microsoft.com)di Microsoft 365 passare a **Impostazioni**  >  **Microsoft Search.** Selezionare la scheda denominata del componente. La **scheda Segnalibri** è selezionata per impostazione predefinita.
...
1. Nel riquadro destro scegliere l'opzione per l'importazione tramite un file CSV o da [SharePoint.](http://sharepoint.com/)
...
Con le impostazioni di ricerca, puoi personalizzare il contenuto e scegliere come destinazione gruppi specifici di utenti. Queste impostazioni di Microsoft Search controllano quando viene visualizzato un risultato di ricerca e chi può vederlo:
...
Microsoft Search mostra il numero di [segnalibri,](manage-bookmarks.md) [domande&A](manage-qas.md)e [Posizioni](manage-locations.md) pubblicati, pianificati o suggeriti. Il [dashboard di Insights](./usage-reports.md) mostra i totali di segnalibro, domande&A e posizione per stato:
