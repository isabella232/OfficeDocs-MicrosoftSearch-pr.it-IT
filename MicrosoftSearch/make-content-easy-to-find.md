...
- Nelle risposte di ricerca non viene visualizzato alcun elemento imprevisto.
...
Microsoft Search viene illustrato il [numero](manage-bookmarks.md)di segnalibri, [domande&A](manage-qas.md)e [Posizioni](manage-locations.md) pubblicati, pianificati o suggeriti. Il [dashboard Insights mostra](./usage-reports.md) i totali di segnalibro, domande&A e posizione per stato:
